                            ...
                            <div style="overflow-x: auto; overflow-y: auto; height: 100%; width: 100%;">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th class="sortable"><a href="/annonce/index?sort=title&amp;max=100&amp;order=asc">Title</a></th>

                                        <th class="sortable"><a href="/annonce/index?sort=description&amp;max=100&amp;order=asc">Description</a></th>

                                        <th class="sortable"><a href="/annonce/index?sort=price&amp;max=100&amp;order=asc">Price</a></th>

                                        <th class="sortable">Illustrations</th>

                                        <th class="sortable"><a href="/annonce/index?sort=isActive&amp;max=100&amp;order=asc">Is Active</a></th>

                                        <th class="sortable"><a href="/annonce/index?sort=author&amp;max=100&amp;order=asc">Author</a></th>
                                        <th>Edit</th>
                                        <th>Delete</th>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <g:each in="${annonce.author}" var="author">
                                                    <g:link controller="user" action="show" id="${author.id}">${author.username}</g:link>
                                                </g:each>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                               <g:form action="delete" id="${annonce.id}" method="DELETE">
